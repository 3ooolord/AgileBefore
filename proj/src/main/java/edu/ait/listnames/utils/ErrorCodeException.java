...
public class ErrorCodeException extends RuntimeException implements Serializable {
    ...
    public ErrorCodeException(CommonException commonException) {
        super(commonException.getMessage());
        this.errorCode = new ErrorCode();
        this.errorCode.setRetcode(commonException.getErrorCode().getRetcode());
        this.errorCode.setCode(this.getClass().getSimpleName());
        this.errorCode.setMessage(commonException.getErrorCode().getMessage());
    }
